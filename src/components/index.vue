    ...
    <div class="index-wrapper">
      ...
      <div id="id-sideMenu" class="index-side-menu">
        <div class="side-menu-top">
          ...
          <h2 class="name">HuangGengWei</h2>
          <p class="desc">仰望星空，也得脚踏实地。</p>
        </div>
        <ul class="menu-list">
          <li class="item">
      ...
      <!--右侧内容-->
      <div id="id-content" class="index-content-wrapper">
        <!--内容header-->
        <div id="id-topBar" class="index-header">
        ...
        <div class="index-content">
          <div class="content-top">
            <canvas id="universe" width="903" height="270"></canvas>
            <div class="footer">
              <svg id="scene" x="0" y="0" width="1600" height="315">
	...
	c-0.8047,2.0459-1.1533,3.7432-0.5103,6.5195s2.7056,4.5264,3.5181,6.2139s0.5-1.6875,0.5-1.6875L27.125,6.2334z"></path>
        ...
        <!--<div class="index-footer">-->
          ...
          <!--<div class="bottom-bar">-->
            <!--<span class="copy">HuangGengWei&nbsp;&nbsp;2018</span>-->
            <!--<span class="record"><a href="#" target="_blank"></a></span>-->
          <!--</div>-->
        <!--</div>-->
        <!--返回顶部-->
