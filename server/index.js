...
// var cmp_handler = (req, res, next) => {
//   var url = req._parsedOriginalUrl.path
//   // console.log('url',url);
//   var mmm = url.match(/.*\/([a-zA-Z0-9_]+)*\/([a-zA-Z0-9_]+)(\.api)?$/)
//   // console.log('mmmmmmmmmmmmmmmmmmmmmmmm', mmm)
//   // console.log('./api/' + mmm[1])
//   return require('./api/' + mmm[1])
// }
// app.use(/.*\/([a-zA-Z0-9_]+)*\/([a-zA-Z0-9_]+)/, cmp_handler)
